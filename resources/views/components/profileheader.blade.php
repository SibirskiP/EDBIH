...
<section class="relative pt-40 ">
    ...
    <div class="w-full max-w-7xl mx-auto px-6 md:px-8">
        ...
        <div class="flex flex-col sm:flex-row max-sm:gap-5 items-center justify-between mb-5">
            <div class="block">
                <h3 class="font-manrope font-bold text-4xl text-gray-900 mb-1">{{$username}}</h3>
                <p class="font-normal text-center sm:text-left text-base leading-7 text-gray-500">{{$lokacija}}</p>
            </div>
            <button
                class="rounded-full py-3.5 px-5 bg-gray-100 flex items-center group transition-all duration-500 hover:bg-blue-100 ">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                    <path class="stroke-gray-700 transition-all duration-500 group-hover:stroke-blue-600"
                ...
                <span
                    class="px-2 font-medium text-base leading-7 text-gray-700 transition-all duration-500 group-hover:text-blue-600">
                        {{$titula}}</span>
            </button>
        </div>
        <div class="flex flex-col lg:flex-row max-lg:gap-5 items-center justify-between py-0.5">
            ...
            <div class="flex items-center gap-4">
                <button type="button" id="defaultModalButton" data-modal-target="defaultModal" data-modal-toggle="defaultModal"
                    class="py-3.5 px-5 rounded-full bg-blue-600 text-white font-semibold text-base leading-7 shadow-sm shadow-transparent transition-all duration-500 hover:shadow-gray-100 hover:bg-blue-700">
                   Uredi profil
                </button>
                <form action="/logout" method="POST">
                    ...
                    <button
                       type="submit" class="py-3.5 px-5 rounded-full bg-blue-50 text-blue-600 font-semibold text-base leading-7 shadow-sm shadow-transparent transition-all duration-500 hover:bg-blue-100">
                        Odjava
                    </button>
                </form>
            ...
            <div class="flex flex-col md:flex-row items-center gap-6 ">
                <p class="flex items-center gap-2 font-medium text-lg leading-8 text-gray-400 ">Kategorije

...
<div class="mx-auto max-w-screen-sm text-center lg:mb-6 mb-6 sm">
    <h2 class="mb-4 text-3xl lg:text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Instrukcije i kursevi</h2>

    <x-dbfilter :categories="$kategorije" buttonText="Kategorija" :index="1" name="kategorija"/>
    <x-dbfilter2 :categories="$lokacije" buttonText="Lokacija" :index="1" name="lokacija"/>

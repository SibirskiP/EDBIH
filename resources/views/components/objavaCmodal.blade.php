...
<div id="defaultModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed inset-0 z-50 flex justify-center items-center bg-black bg-opacity-50">
    <div class="relative p-4 w-full max-w-2xl h-auto">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <!-- Modal body -->
            <form action="/objave" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-2">
                        <label for="profilna_slika" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Dodaj prateći materijal ili sliku (možete preskočiti ovaj korak)</label>
                        ...
                        <div class="w-full py-9 bg-gray-50 rounded-2xl border border-gray-300 gap-3 grid border-dashed">
                            <div class="grid gap-1">
                                ...
                                <h2 class="text-center text-gray-400   text-xs leading-4">fajl manji od 4MB</h2>
                            </div>
                            <div class="grid gap-2">
                                <h4 class="text-center text-gray-900 text-sm font-medium leading-snug">Privuci ili izaberi fajl</h4>
                                <div class="flex items-center justify-center">
                                    <label>
                                        <input type="file" id="materijal" name="materijal" hidden onchange="prikaziImeFajla()" />

<div>
    ...
    <div class="mx-auto max-w-screen-lg text-center  mt-12">
        <h2 class="mb-4 text-4xl lg:text-5xl tracking-tight font-extrabold text-slate-800">
            Najnovije <span class="text-blue-600">Objave</span>
        </h2>
        <p class="mt-3 text-lg text-slate-600">
            Pregledajte najnovije vijesti, obavijesti i članke iz naše zajednice.
        </p>
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-center">
            ...
            <div class="relative">
                <button type="button" class="w-full bg-white border border-slate-300 rounded-lg shadow-sm px-4 py-2.5 text-left flex items-center justify-between text-slate-800 hover:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200"
                        onclick="toggleDropdown('dropdownCategory')"> {{-- ID promijenjen u dropdownCategory za konzistentnost --}}
            ...
            {{-- Objava ne sadrži lokacije, pa je ovo placeholder, ili možete prilagoditi grid na lg:grid-cols-3 --}}
    ...
    @else
        <div class="grid gap-8 grid-cols-1 lg:grid-cols-1"> {{-- Objava je obično cijelom širinom --}}
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Nema pretraživanja za lokacije u ovom kodu, ali ostavljam za referencu ako se doda
        ...
        window.addEventListener('click', function (event) {
            let dropdowns = ['dropdownCategory']; // Samo kategorija je dropdown
